...
def run(num_modes: int = 6, predicted_traj_len: int = 12) -> None:
    ...
    nusc = NuScenes(version='v1.0-mini',
                    dataroot='data/openv2v_4_cams', verbose=False)
    ...
    res = {}
    res['K_mode'] = 6
    res['anchors_all'] = kmeans_anchors
    res['class_list'] = [[0]]
    res['grouped_classes'] = [['car']]

    pkl_path = 'data/others/cooper_uniad_motion_anchor_infos_mode6.pkl'
