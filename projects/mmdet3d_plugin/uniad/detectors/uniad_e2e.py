...
class UniAD(UniADTrack):
    ...
    def forward(self, return_loss=True, **kwargs):
        ...
        augmentations.
        """
        print(f'------[UniAD] Forward function: return_loss={return_loss}--------')
        if return_loss:
    ...
    @auto_fp16(apply_to=('img', 'sender_img', 'points'))
    def forward_train(self,
        ...
        sender_img_metas = sender_img_metas
        ...
        losses_track, outs_track = self.forward_track_train(img, gt_bboxes_3d, gt_labels_3d, gt_past_traj, gt_past_traj_mask, gt_inds, gt_sdc_bbox, gt_sdc_label,
                                                        l2g_t, l2g_r_mat, img_metas, timestamp, sender_img, sender_img_metas, sender_gt_bboxes_3d, sender_gt_labels_3d, sender_gt_inds, sender_gt_past_traj, sender_gt_past_traj_mask)
    ...
    def forward_test(self,
        ...
        result_track = self.simple_test_track(img, l2g_t, l2g_r_mat, img_metas, timestamp, sender_img, sender_img_metas)
