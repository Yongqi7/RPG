...
model = dict(
    ...
    enable_map_fusion=enable_map_fusion,
    enable_ref_pts_fusion=enable_ref_pts_fusion,
    use_oracle_ref_pts=use_oracle_ref_pts,
    simulate_heterogeneous_sender=simulate_heterogeneous_sender,
    heterogeneous_fn_rate=heterogeneous_fn_rate,
    heterogeneous_fp_rate=heterogeneous_fp_rate,
    ...
    motion_head=dict(
        ...
        anchor_info_path='data/m3cad_carla_ue5/others/m3cad_uniad_motion_anchor_infos_mode6.pkl',
        transformerlayers=dict(
